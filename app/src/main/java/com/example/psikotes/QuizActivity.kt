...
class QuizActivity : AppCompatActivity() {
    ...
    private fun handleOptionClick(button: Button, optionIndex: Int) {
        // Reset tombol sebelumnya ke warna default
        selectedButton?.setBackgroundColor(resources.getColor(R.color.colorPrimary, theme))
        selectedButton?.setTextColor(resources.getColor(android.R.color.white, theme))

        // Tandai tombol yang dipilih dengan warna lebih gelap
        button.setBackgroundColor(resources.getColor(R.color.colorDarker, theme))
        button.setTextColor(resources.getColor(android.R.color.white, theme))

        // Simpan referensi tombol yang dipilih
